    ...
    className={`btn btn-sm ${!priority ? "btn-warning" : "btn-primary"} float-end`}>
      ...
      <ul className="list-group">
        ...
        <li className="list-group-item" key={item.uuid}>
            {item.priority && <span className="badge text-bg-secondary me-3">
            <svg className="mx-2" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-rocket-takeoff" viewBox="0 0 16 16">
